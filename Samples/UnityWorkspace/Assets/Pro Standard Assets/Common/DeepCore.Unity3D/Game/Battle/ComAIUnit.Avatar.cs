    ...
    public partial class ComAIUnit
    {
        ...
        public Avatar AddAvatar(string assetBundleName, string assetName)
        {
                ...
                && !string.IsNullOrEmpty(assetName))
            {
                ...
                FuckAssetLoader.GetOrLoad(assetBundleName, assetName, (loader) =>
                {
                    ...
                    if (loader.AssetComp)
                    {
                        ...
                        info.DisplayCell.SetModel(loader.AssetComp);
                        this.animPlayer.AddAnimator(loader.AssetComp.gameObject.GetComponent<Animator>());
        ...
        public void RemoveAvatar(Avatar info)
        {
            ...
            {
                this.animPlayer.RemoveAnimator(info.DisplayCell.ObjectRoot.gameObject.GetComponent<Animator>());
