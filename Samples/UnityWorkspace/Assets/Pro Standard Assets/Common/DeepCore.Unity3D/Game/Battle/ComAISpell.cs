...
namespace DeepCore.Unity3D.Battle
{
    public partial class ComAISpell : ComAICell
    {
            ...
            : base(battleScene, obj)
        {
            ...
            {
                FuckAssetLoader.GetOrLoad(ZSpell.Info.FileName, System.IO.Path.GetFileNameWithoutExtension(ZSpell.Info.FileName), (loader) =>
                {
                    if (loader.AssetComp)
                    {
                        if (IsDisposed)
                        ...
                        OnLoadModelSuccess(loader.AssetComp);
                    }
                });
            }
        }
