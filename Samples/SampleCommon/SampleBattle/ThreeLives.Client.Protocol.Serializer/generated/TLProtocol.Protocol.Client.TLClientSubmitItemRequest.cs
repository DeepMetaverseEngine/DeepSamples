...
namespace TLClient
{
    ...
    {
        // msg id    : 0x00073003 : 471043
        // base type : DeepMMO.Protocol.Request
        public static void W_TLProtocol_Protocol_Client_TLClientSubmitItemRequest(IOutputStream output, object msg)
        {
            var data = (TLProtocol.Protocol.Client.TLClientSubmitItemRequest)msg;
            W_DeepMMO_Protocol_Request(output, data);
            output.PutList(data.c2s_data, output.PutObj);
            output.PutS32(data.c2s_questId);
        }
        public static void R_TLProtocol_Protocol_Client_TLClientSubmitItemRequest(IInputStream input, object msg)
        {
            var data = (TLProtocol.Protocol.Client.TLClientSubmitItemRequest)msg;
