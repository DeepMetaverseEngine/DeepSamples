...
local _M = {MessageID = 0x0009802E,Name = 'TLProtocol.Protocol.Client.ClientGetMonsterInfoResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0009802E] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientGetMonsterInfoResponse'] = _M
