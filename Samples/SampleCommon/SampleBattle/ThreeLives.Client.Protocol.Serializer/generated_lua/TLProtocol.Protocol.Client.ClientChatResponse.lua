...
local _M = {MessageID = 0x00092002,Name = 'TLProtocol.Protocol.Client.ClientChatResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00092002] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientChatResponse'] = _M
