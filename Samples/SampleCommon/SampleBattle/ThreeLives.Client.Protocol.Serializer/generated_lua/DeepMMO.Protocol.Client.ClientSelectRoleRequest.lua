...
local _M = {MessageID = 0x00033001,Name = 'DeepMMO.Protocol.Client.ClientSelectRoleRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00033001] = _M
Protocol.Serializer.StringDefined['DeepMMO.Protocol.Client.ClientSelectRoleRequest'] = _M
