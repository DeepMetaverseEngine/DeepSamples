...
local _M = {MessageID = 0x0009E209,Name = 'ThreeLives.Client.Protocol.Protocol.Client.ClientCanBuyTicketsRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0009E209] = _M
Protocol.Serializer.StringDefined['ThreeLives.Client.Protocol.Protocol.Client.ClientCanBuyTicketsRequest'] = _M
