...
local _M = {MessageID = 0x00050033,Name = 'TLProtocol.Protocol.Client.ClientWeddingReservationRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00050033] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientWeddingReservationRequest'] = _M
