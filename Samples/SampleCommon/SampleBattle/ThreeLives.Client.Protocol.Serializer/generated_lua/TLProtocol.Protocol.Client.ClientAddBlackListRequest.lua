...
local _M = {MessageID = 0x0005000D,Name = 'TLProtocol.Protocol.Client.ClientAddBlackListRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0005000D] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientAddBlackListRequest'] = _M
