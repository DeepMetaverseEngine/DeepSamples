...
local _M = {MessageID = 0x00099010,Name = 'TLProtocol.Protocol.Client.ClientPartnerUpgradeQualityResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00099010] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientPartnerUpgradeQualityResponse'] = _M
