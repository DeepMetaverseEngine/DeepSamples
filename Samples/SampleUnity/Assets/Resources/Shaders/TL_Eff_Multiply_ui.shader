...
Shader "TL/Eff/Multiply_ui" {
Properties {
	_TintColor ("Tint Color", Color) = (0.5,0.5,0.5,0.5)	
	_MainTex ("Particle Texture", 2D) = "white" {}
	_InvFade ("Soft Particles Factor", Range(0.01,3.0)) = 1.0
	_alpha ("Soft Particles Factor", Range(0.01,3.0)) = 1.0
		//新增 记录裁剪框的四个边界的值
	...
	SubShader {
		Pass {
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = lerp(half4(1,1,1,1), prev, prev.a*_alpha);
				...
				return inArea ? col : fixed4(1, 1, 1, 1);
