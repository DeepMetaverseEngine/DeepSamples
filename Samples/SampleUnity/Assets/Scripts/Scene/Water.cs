...
namespace UnityStandardAssets.Water
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        void OnDisable()
        {
            ...
            {
                DeepCore.Unity3D.UnityHelper.DestroyImmediate(m_ReflectionTexture);
                m_ReflectionTexture = null;
            }
            if (m_RefractionTexture)
            {
                DeepCore.Unity3D.UnityHelper.DestroyImmediate(m_RefractionTexture);
                m_RefractionTexture = null;
            }
            foreach (var kvp in m_ReflectionCameras)
            {
                DeepCore.Unity3D.UnityHelper.DestroyImmediate((kvp.Value).gameObject);
            }
