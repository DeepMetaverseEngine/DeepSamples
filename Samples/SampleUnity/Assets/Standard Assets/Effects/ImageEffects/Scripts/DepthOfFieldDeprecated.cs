    ...
    public class DepthOfFieldDeprecated : PostEffectsBase
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
           ...
           // }
            ...
            Graphics.Blit(source, blurForeground ? foregroundTexture : destination, dofMaterial, 0);//visualize ? 2 : 0);
            ...
            if (blurForeground) {
               ...
               // }
                ...
                Graphics.Blit(source, destination, dofMaterial, 4);//visualize ? 1 : 4);
