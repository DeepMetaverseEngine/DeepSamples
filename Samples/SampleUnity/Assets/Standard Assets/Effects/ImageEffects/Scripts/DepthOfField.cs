...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class DepthOfField : PostEffectsBase {
        ...
        void OnDestroy()
        {
            ...
            if (dofHdrMaterial) GameObject.DestroyImmediate(dofHdrMaterial);
            dofHdrMaterial = null;
            if (dx11bokehMaterial) GameObject.DestroyImmediate(dx11bokehMaterial);
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination) {
            if (enable_self == false || !CheckResources ()) {
