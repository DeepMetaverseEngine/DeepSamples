...
namespace DeepCore.Unity3D.Impl
{
    public struct UnityVertexBuffer : VertexBuffer
    {
        ...
        private ListObjectPool<int>.AutoRelease mIndices;
        private ListObjectPool<Vector3>.AutoRelease mPos;
        private ListObjectPool<Vector2>.AutoRelease mUVs;
        ...
        public void Dispose()
        {
            ((IDisposable)mIndices).Dispose();
            ((IDisposable)mPos).Dispose();
            ((IDisposable)mUVs).Dispose();
            mIndices = null;
            mPos = null;
            mUVs = null;
        }
