...
public class Lua_UnityEngine_QualitySettings : LuaObject {
	...
	static public int get_shadows(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.QualitySettings.shadows);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_shadowResolution(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.QualitySettings.shadowResolution);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_shadowmaskMode(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.QualitySettings.shadowmaskMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
