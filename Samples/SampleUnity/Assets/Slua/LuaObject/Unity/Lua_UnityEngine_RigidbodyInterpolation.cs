...
public class Lua_UnityEngine_RigidbodyInterpolation : LuaObject {
	...
	static public int getNone(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.RigidbodyInterpolation.None);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_None(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.RigidbodyInterpolation.None);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getInterpolate(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.RigidbodyInterpolation.Interpolate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Interpolate(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.RigidbodyInterpolation.Interpolate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getExtrapolate(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.RigidbodyInterpolation.Extrapolate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Extrapolate(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.RigidbodyInterpolation.Extrapolate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.RigidbodyInterpolation));
	}
}
