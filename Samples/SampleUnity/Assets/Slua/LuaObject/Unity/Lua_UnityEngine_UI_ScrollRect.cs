...
public class Lua_UnityEngine_UI_ScrollRect : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int DONormalizedPos(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			...
			var ret=self.DONormalizedPos(a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int DOHorizontalNormalizedPos(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			System.Single a2;
			checkType(l,2,out a2);
			...
			System.Boolean a4;
			checkType(l,4,out a4);
			var ret=self.DOHorizontalNormalizedPos(a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int DOVerticalNormalizedPos(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			System.Single a2;
			checkType(l,2,out a2);
			...
			System.Boolean a4;
			checkType(l,4,out a4);
			var ret=self.DOVerticalNormalizedPos(a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int get_horizontalScrollbarVisibility(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.horizontalScrollbarVisibility);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_verticalScrollbarVisibility(IntPtr l) {
		try {
			UnityEngine.UI.ScrollRect self=(UnityEngine.UI.ScrollRect)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.verticalScrollbarVisibility);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,DONormalizedPos);
		addMember(l,DOHorizontalNormalizedPos);
		addMember(l,DOVerticalNormalizedPos);
