...
public class Lua_UnityEngine_RectTransform : LuaObject {
	...
	static public int DOShakeAnchorPos(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(float),typeof(UnityEngine.Vector2),typeof(int),typeof(float),typeof(bool),typeof(bool))){
				UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
				System.Single a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,2,typeof(float),typeof(float),typeof(int),typeof(float),typeof(bool),typeof(bool))){
				UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
				System.Single a2;
				checkType(l,2,out a2);
				System.Single a3;
