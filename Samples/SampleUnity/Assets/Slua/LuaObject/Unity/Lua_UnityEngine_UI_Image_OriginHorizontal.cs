...
public class Lua_UnityEngine_UI_Image_OriginHorizontal : LuaObject {
	...
	static public int getLeft(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.OriginHorizontal.Left);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Left(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.OriginHorizontal.Left);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getRight(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.OriginHorizontal.Right);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Right(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.OriginHorizontal.Right);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Image.OriginHorizontal));
	}
}
