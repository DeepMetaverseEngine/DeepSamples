...
public class Lua_UnityEngine_ConfigurableJoint : LuaObject {
	...
	static public int get_angularXMotion(IntPtr l) {
		try {
			UnityEngine.ConfigurableJoint self=(UnityEngine.ConfigurableJoint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.angularXMotion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_angularYMotion(IntPtr l) {
		try {
			UnityEngine.ConfigurableJoint self=(UnityEngine.ConfigurableJoint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.angularYMotion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_angularZMotion(IntPtr l) {
		try {
			UnityEngine.ConfigurableJoint self=(UnityEngine.ConfigurableJoint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.angularZMotion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_rotationDriveMode(IntPtr l) {
		try {
			UnityEngine.ConfigurableJoint self=(UnityEngine.ConfigurableJoint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.rotationDriveMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_projectionMode(IntPtr l) {
		try {
			UnityEngine.ConfigurableJoint self=(UnityEngine.ConfigurableJoint)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.projectionMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
