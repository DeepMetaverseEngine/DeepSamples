...
public class Lua_UnityEngine_UI_Image_Origin180 : LuaObject {
	...
	static public int getBottom(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.Origin180.Bottom);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Bottom(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.Origin180.Bottom);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getLeft(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.Origin180.Left);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Left(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.Origin180.Left);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getTop(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.Origin180.Top);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Top(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.Origin180.Top);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getRight(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Image.Origin180.Right);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Right(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Image.Origin180.Right);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Image.Origin180));
	}
}
