...
public class Lua_UnityEngine_UI_GridLayoutGroup_Axis : LuaObject {
	...
	static public int getHorizontal(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.GridLayoutGroup.Axis.Horizontal);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Horizontal(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.GridLayoutGroup.Axis.Horizontal);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getVertical(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.GridLayoutGroup.Axis.Vertical);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Vertical(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.GridLayoutGroup.Axis.Vertical);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.GridLayoutGroup.Axis));
	}
}
