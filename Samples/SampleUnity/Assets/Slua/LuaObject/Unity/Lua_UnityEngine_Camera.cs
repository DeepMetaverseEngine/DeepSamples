...
public class Lua_UnityEngine_Camera : LuaObject {
	...
	static public int get_renderingPath(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.renderingPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_actualRenderingPath(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.actualRenderingPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_opaqueSortMode(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.opaqueSortMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_transparencySortMode(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.transparencySortMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_stereoTargetEye(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.stereoTargetEye);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_stereoActiveEye(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.stereoActiveEye);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_depthTextureMode(IntPtr l) {
		try {
			UnityEngine.Camera self=(UnityEngine.Camera)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.depthTextureMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
