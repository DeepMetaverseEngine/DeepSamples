...
public class Lua_UnityEngine_UI_Scrollbar_Direction : LuaObject {
	...
	static public int getLeftToRight(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Scrollbar.Direction.LeftToRight);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_LeftToRight(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Scrollbar.Direction.LeftToRight);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getRightToLeft(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Scrollbar.Direction.RightToLeft);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_RightToLeft(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Scrollbar.Direction.RightToLeft);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getBottomToTop(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Scrollbar.Direction.BottomToTop);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_BottomToTop(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Scrollbar.Direction.BottomToTop);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getTopToBottom(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.UI.Scrollbar.Direction.TopToBottom);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_TopToBottom(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.UI.Scrollbar.Direction.TopToBottom);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Scrollbar.Direction));
	}
}
