...
public class Lua_UnityEngine_CollisionDetectionMode2D : LuaObject {
	...
	static public int getDiscrete(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.CollisionDetectionMode2D.Discrete);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Discrete(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.CollisionDetectionMode2D.Discrete);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int getContinuous(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,UnityEngine.CollisionDetectionMode2D.Continuous);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Continuous(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,(double)UnityEngine.CollisionDetectionMode2D.Continuous);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(UnityEngine.CollisionDetectionMode2D));
	}
}
