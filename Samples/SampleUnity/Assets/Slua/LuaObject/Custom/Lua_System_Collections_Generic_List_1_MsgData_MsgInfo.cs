...
public class Lua_System_Collections_Generic_List_1_MsgData_MsgInfo : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<MsgData.MsgInfo> o;
			if(argc==1){
				o=new System.Collections.Generic.List<MsgData.MsgInfo>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<MsgData.MsgInfo>))){
				System.Collections.Generic.IEnumerable<MsgData.MsgInfo> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<MsgData.MsgInfo>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<MsgData.MsgInfo> self=(System.Collections.Generic.List<MsgData.MsgInfo>)checkSelf(l);
			MsgData.MsgInfo a1;
			checkType(l,2,out a1);
			self.Add(a1);
			pushValue(l,true);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				MsgData.MsgInfo a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<MsgData.MsgInfo> a2;
				...
				System.Collections.Generic.IComparer<MsgData.MsgInfo> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<MsgData.MsgInfo> self=(System.Collections.Generic.List<MsgData.MsgInfo>)checkSelf(l);
			System.Predicate<MsgData.MsgInfo> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<MsgData.MsgInfo> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<MsgData.MsgInfo> a3;
	...
	static public int ForEach(IntPtr l) {
		try {
			System.Collections.Generic.List<MsgData.MsgInfo> self=(System.Collections.Generic.List<MsgData.MsgInfo>)checkSelf(l);
			System.Action<MsgData.MsgInfo> a1;
			checkDelegate(l,2,out a1);
			self.ForEach(a1);
			pushValue(l,true);
			return 1;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<MsgData.MsgInfo> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<MsgData.MsgInfo>))){
				System.Collections.Generic.List<MsgData.MsgInfo> self=(System.Collections.Generic.List<MsgData.MsgInfo>)checkSelf(l);
				System.Comparison<MsgData.MsgInfo> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<MsgData.MsgInfo>))){
				System.Collections.Generic.List<MsgData.MsgInfo> self=(System.Collections.Generic.List<MsgData.MsgInfo>)checkSelf(l);
				System.Collections.Generic.IComparer<MsgData.MsgInfo> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<MsgData.MsgInfo> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<MsgData.MsgInfo, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<MsgData.MsgInfo>));
	}
}
