...
public class Lua_DeepCore_HashMap_2_string_string : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			DeepCore.HashMap<System.String,System.String> o;
			if(argc==1){
				o=new DeepCore.HashMap<System.String,System.String>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new DeepCore.HashMap<System.String,System.String>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new DeepCore.HashMap<System.String,System.String>(a1,a2);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Get(IntPtr l) {
		try {
			DeepCore.HashMap<System.String,System.String> self=(DeepCore.HashMap<System.String,System.String>)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
			var ret=self.Get(a1);
			pushValue(l,true);
	...
	static public int TryGetOrCreate(IntPtr l) {
		try {
			...
			System.String a2;
			checkType(l,3,out a2);
			System.Func<System.String,System.String> a3;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DeepCore.HashMap<<System.String, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089>,<System.String, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089>>");
		addMember(l,Get);
		addMember(l,Put);
		addMember(l,TryAdd);
		...
		createTypeMetatable(l,constructor, typeof(DeepCore.HashMap<System.String,System.String>),typeof(System.Collections.Generic.Dictionary<System.String,System.String>));
	}
}
