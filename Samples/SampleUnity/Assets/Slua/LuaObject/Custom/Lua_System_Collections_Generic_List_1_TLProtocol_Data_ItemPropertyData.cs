...
public class Lua_System_Collections_Generic_List_1_TLProtocol_Data_ItemPropertyData : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> o;
			if(argc==1){
				o=new System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> self=(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>)checkSelf(l);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				TLProtocol.Data.ItemPropertyData a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<TLProtocol.Data.ItemPropertyData> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				TLProtocol.Data.ItemPropertyData a3;
				checkType(l,4,out a3);
				System.Collections.Generic.IComparer<TLProtocol.Data.ItemPropertyData> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> self=(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>)checkSelf(l);
			System.Predicate<TLProtocol.Data.ItemPropertyData> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<TLProtocol.Data.ItemPropertyData> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<TLProtocol.Data.ItemPropertyData> a3;
	...
	static public int ForEach(IntPtr l) {
		try {
			System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> self=(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>)checkSelf(l);
			System.Action<TLProtocol.Data.ItemPropertyData> a1;
			checkDelegate(l,2,out a1);
			self.ForEach(a1);
			pushValue(l,true);
			return 1;
	...
	static public int Insert(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			TLProtocol.Data.ItemPropertyData a2;
			checkType(l,3,out a2);
			self.Insert(a1,a2);
			pushValue(l,true);
			return 1;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<TLProtocol.Data.ItemPropertyData> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<TLProtocol.Data.ItemPropertyData>))){
				System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> self=(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>)checkSelf(l);
				System.Comparison<TLProtocol.Data.ItemPropertyData> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<TLProtocol.Data.ItemPropertyData>))){
				System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData> self=(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>)checkSelf(l);
				System.Collections.Generic.IComparer<TLProtocol.Data.ItemPropertyData> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<TLProtocol.Data.ItemPropertyData> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public int setItem(IntPtr l) {
		try {
			...
			int v;
			checkType(l,2,out v);
			TLProtocol.Data.ItemPropertyData c;
			checkType(l,3,out c);
			self[v]=c;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<TLProtocol.Data.ItemPropertyData, ThreeLives.Client.Protocol, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<TLProtocol.Data.ItemPropertyData>));
	}
}
