...
public class Lua_System_Collections_Generic_List_1_PlayerMapData : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<PlayerMapData> o;
			if(argc==1){
				o=new System.Collections.Generic.List<PlayerMapData>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<PlayerMapData>))){
				System.Collections.Generic.IEnumerable<PlayerMapData> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<PlayerMapData>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<PlayerMapData> self=(System.Collections.Generic.List<PlayerMapData>)checkSelf(l);
			PlayerMapData a1;
			checkType(l,2,out a1);
			self.Add(a1);
			pushValue(l,true);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				PlayerMapData a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<PlayerMapData> a2;
				...
				System.Collections.Generic.IComparer<PlayerMapData> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<PlayerMapData> self=(System.Collections.Generic.List<PlayerMapData>)checkSelf(l);
			System.Predicate<PlayerMapData> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<PlayerMapData> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<PlayerMapData> a3;
	...
	static public int ForEach(IntPtr l) {
		try {
			System.Collections.Generic.List<PlayerMapData> self=(System.Collections.Generic.List<PlayerMapData>)checkSelf(l);
			System.Action<PlayerMapData> a1;
			checkDelegate(l,2,out a1);
			self.ForEach(a1);
			pushValue(l,true);
			return 1;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<PlayerMapData> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<PlayerMapData>))){
				System.Collections.Generic.List<PlayerMapData> self=(System.Collections.Generic.List<PlayerMapData>)checkSelf(l);
				System.Comparison<PlayerMapData> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<PlayerMapData>))){
				System.Collections.Generic.List<PlayerMapData> self=(System.Collections.Generic.List<PlayerMapData>)checkSelf(l);
				System.Collections.Generic.IComparer<PlayerMapData> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<PlayerMapData> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<PlayerMapData, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<PlayerMapData>));
	}
}
