...
public class Lua_DeepCore_Unity3D_UGUI_DisplayNodeInteractive : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int OnPointerDown(IntPtr l) {
		try {
			DeepCore.Unity3D.UGUI.DisplayNodeInteractive self=(DeepCore.Unity3D.UGUI.DisplayNodeInteractive)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DeepCore.Unity3D.UGUI.DisplayNodeInteractive");
		...
		createTypeMetatable(l,null, typeof(DeepCore.Unity3D.UGUI.DisplayNodeInteractive),typeof(UnityEngine.UI.Selectable));
	}
}
