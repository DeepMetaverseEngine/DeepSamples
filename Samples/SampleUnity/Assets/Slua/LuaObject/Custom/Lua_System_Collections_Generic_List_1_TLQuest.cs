...
public class Lua_System_Collections_Generic_List_1_TLQuest : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<TLQuest> o;
			if(argc==1){
				o=new System.Collections.Generic.List<TLQuest>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<TLQuest>))){
				System.Collections.Generic.IEnumerable<TLQuest> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<TLQuest>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<TLQuest> self=(System.Collections.Generic.List<TLQuest>)checkSelf(l);
			TLQuest a1;
			checkType(l,2,out a1);
			self.Add(a1);
			pushValue(l,true);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				TLQuest a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<TLQuest> a2;
				...
				System.Collections.Generic.IComparer<TLQuest> a4;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<TLQuest> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<TLQuest>))){
				System.Collections.Generic.List<TLQuest> self=(System.Collections.Generic.List<TLQuest>)checkSelf(l);
				System.Comparison<TLQuest> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IComparer<TLQuest>))){
				System.Collections.Generic.List<TLQuest> self=(System.Collections.Generic.List<TLQuest>)checkSelf(l);
				System.Collections.Generic.IComparer<TLQuest> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<TLQuest> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"List<<TLQuest, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null>>");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<TLQuest>));
	}
}
