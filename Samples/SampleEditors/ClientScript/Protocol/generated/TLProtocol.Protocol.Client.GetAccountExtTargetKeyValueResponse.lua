...
local _M = {MessageID = 0x0009602F,Name = 'TLProtocol.Protocol.Client.GetAccountExtTargetKeyValueResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0009602F] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.GetAccountExtTargetKeyValueResponse'] = _M
