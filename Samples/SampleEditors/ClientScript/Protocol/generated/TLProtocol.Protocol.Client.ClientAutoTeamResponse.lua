...
local _M = {MessageID = 0x00095010,Name = 'TLProtocol.Protocol.Client.ClientAutoTeamResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00095010] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientAutoTeamResponse'] = _M
