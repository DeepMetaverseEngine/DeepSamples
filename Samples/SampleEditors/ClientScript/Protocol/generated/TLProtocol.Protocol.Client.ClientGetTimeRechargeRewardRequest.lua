...
local _M = {MessageID = 0x0009D007,Name = 'TLProtocol.Protocol.Client.ClientGetTimeRechargeRewardRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0009D007] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientGetTimeRechargeRewardRequest'] = _M
