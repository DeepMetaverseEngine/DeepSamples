...
local _M = {MessageID = 0x0004001A,Name = 'TLProtocol.Protocol.Client.TLClientOpenBoxResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0004001A] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.TLClientOpenBoxResponse'] = _M
