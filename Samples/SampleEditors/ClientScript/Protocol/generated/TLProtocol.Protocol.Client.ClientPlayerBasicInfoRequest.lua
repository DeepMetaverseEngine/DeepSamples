...
local _M = {MessageID = 0x0005001B,Name = 'TLProtocol.Protocol.Client.ClientPlayerBasicInfoRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0005001B] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientPlayerBasicInfoRequest'] = _M
