...
local _M = {MessageID = 0x0003700E,Name = 'TLProtocol.Protocol.Client.ClientCombineItemRequest'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0003700E] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.ClientCombineItemRequest'] = _M
