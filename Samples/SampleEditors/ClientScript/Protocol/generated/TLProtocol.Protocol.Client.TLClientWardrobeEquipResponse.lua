...
local _M = {MessageID = 0x0006C00A,Name = 'TLProtocol.Protocol.Client.TLClientWardrobeEquipResponse'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x0006C00A] = _M
Protocol.Serializer.StringDefined['TLProtocol.Protocol.Client.TLClientWardrobeEquipResponse'] = _M
