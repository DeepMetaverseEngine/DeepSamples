...
local _M = {MessageID = 0x00035004,Name = 'DeepMMO.Protocol.Client.LogicTimeNotify'}
_M.__index = _M
function _M.IsSuccess(self)
	return self.s2c_code == 200
end
Protocol.Serializer[0x00035004] = _M
Protocol.Serializer.StringDefined['DeepMMO.Protocol.Client.LogicTimeNotify'] = _M
