...
--	api.Unit.AddBubbleTalk(30001,"這是個NPC測試泡泡","0",2000)
	...
	--api.Unit.AddBubbleTalk(30033,"過了橋就是我家了","0",4)
      local params = {
     	duration = 10,
     	nodeparams = "30026", --①模板id為0就是玩家自己反之就是unit模板id ②掛指定模板 后面沒有節點名字 就默認走腳底,節點注意大小寫，
 	 }
	 ...
	 api.PlaySceneEffect(30026,"ef_god_05_buff",params)
 	 api.Unit.ChangeUnitPlayAnim(30026,action)
	  api.Sleep(0.5)
	-- api.Unit.ChangeUnitPlayAnim(30026,'n_idle')
	  
	 api.Sleep(0.5)
	api.Unit.AddBubbleTalk(30026,"謝謝你救了我！","0",4)
