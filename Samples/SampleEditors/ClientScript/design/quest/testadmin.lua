...
--	api.Unit.AddBubbleTalk(30001,"這是個NPC測試泡泡","0",2000)
	...
	--api.CanSkipCG(true)
    --api.ShowChapter(2)
    -- api.SendChat("@gm add exp 99999999")
    -- api.SendChat("@gm add 200002 1")
    -- api.SendChat("@gm add 200005 1")
    -- api.SendChat("@gm add 200061 1")	
    -- api.SendChat("@gm openfunc all")	
    api.SendChat("@gm add 220408 1")
    api.SendChat("@gm add 220407 1")
    api.SendChat("@gm add 220406 1")
    api.SendChat("@gm add 220405 1")
    api.SendChat("@gm add 220404 1")
    api.SendChat("@gm add 220403 1")
    api.SendChat("@gm add 220402 1")
end