function main()
	...
	api.Unit.AddBubbleTalk(0,"怎么会这样，你的诅咒为什么没有被解除！？","0",2)
	api.Sleep(2)
	api.Unit.AddBubbleTalk(30050,"这可能就是命运吧！","0",2)
	api.Sleep(2)
    api.Unit.AddBubbleTalk(0,"那你会履行你的诺言吗？毕竟我完全是按你说的在做！","0",2)
	api.Sleep(2)
	api.Unit.AddBubbleTalk(30050,"放心吧，我既然觉得这是命运，我当然会坦然接受它的！","0",2)
	api.Sleep(3)
