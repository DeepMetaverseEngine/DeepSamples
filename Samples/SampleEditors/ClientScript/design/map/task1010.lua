function main()
	...
	api.Unit.AddBubbleTalk(30023,"王子上次出海遇到了一个美丽的人鱼公主！","0",4)
	api.Sleep(2)
	api.Unit.AddBubbleTalk(0,"王子与公主的爱情故事？","0",2)
	api.Sleep(2)
    api.Unit.AddBubbleTalk(30023,"后来公主为了和王子在一起，就把鱼尾变成了人腿，可是她的脸变成了鱼！","0",4)
	api.Sleep(2)
	api.Unit.AddBubbleTalk(0,"然后王子就不要她了?","0",2)
	api.Sleep(3)
