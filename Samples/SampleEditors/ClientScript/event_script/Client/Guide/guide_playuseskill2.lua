function main()
   ...
   --      local id = Api.Guide.Listen.Touch(obj,{text = Constants.GuideText.UseSkill,y = 0, right = true,  force = false,type = 2})
        ...
        local obj =  Api.Scene.FindGameObject('UGUI_ROOT/HudRoot/SkillManager/Skill_2/skill/Num/BattleNumber')
        local skillobj =  Api.Scene.FindGameObject('UGUI_ROOT/HudRoot/SkillManager/Skill_2/skill')
        local id 
