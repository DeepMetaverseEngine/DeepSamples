...
local function OutputMemorySnapshot(strSavePath, strExtraFileName, nMaxRescords, strRootObjectName, cRootObject, cDumpInfoResultsBase, cDumpInfoResults)
	...
	if cDumpInfoResultsBase then
		...
		cOutputer('--------------------------------------------------------\n')
		cOutputer(
			'-- Collect base memory reference at line:' .. tostring(cDumpInfoResultsBase.m_nCurrentLine) .. '@file:' .. cDumpInfoResultsBase.m_strShortSrc .. '\n'
		)
...
local function OutputMemorySnapshotSingleObject(strSavePath, strExtraFileName, nMaxRescords, cDumpInfoResults)
	...
	cOutputer('--------------------------------------------------------\n')
	cOutputer(
		'-- Collect single object memory reference at line:' .. tostring(cDumpInfoResults.m_nCurrentLine) .. '@file:' .. cDumpInfoResults.m_strShortSrc .. '\n'
	)
	cOutputer('--------------------------------------------------------\n')
	...
	cOutputer(
		'-- For Object: ' ..
			cDumpInfoResults.m_strAddressName .. ' (' .. cDumpInfoResults.m_strObjectName .. '), have ' .. tostring(nCount) .. ' reference in total.\n'
	)
	cOutputer('--------------------------------------------------------\n')
